...
export const signup =  async (req, res, next) => {
    ...
    try{
        ...
        if (existingUser) {
            return next(errorHandler(400, 'User with the same email and user type already exists'));
        }
...
export const google = async (req, res, next) => {
    try {
        ...
        if(user) {
            ...
            email: req.body.email, password: hashedPassword, avatar: req.body.photo, userType: req.body.userType});
            await newUser.save();
