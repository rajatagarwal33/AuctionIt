      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 " >
        ...
        <p className="text-sm self-center">
          ...
          filePerc > 0 && filePerc < 100 ? (
            ...
            filePerc === 100 ? (
            <span className="text-slate-700">Uploading complete</span>
            ) : (
            "" 
          )}
        </p>
        ...
        <button disabled={loading} className="bg-blue-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:bg-opacity-80">
          {loading ? 'Loading...' : 'Update'}
        </button>
        {currentUser.userType === 'seller' && (
        <Link className="bg-green-700 text-white p-3 rounde-lg uppercase text-center hover:opacity-95" to="/create-listing">
          Create listing
        </Link>   
        )}
      </form>
