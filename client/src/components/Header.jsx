...
export default function Header() {
  ...
  return (
    <header className='bg-blue-400 shadow-md'>
      ...
      <Link to='/'>
        <li className='hidden sm:inline text-blue-900 hover:underline'>Home</li>
        </Link>
        <Link to='/about'>
        <li className=' hidden sm:inline text-blue-900 hover:underline'>About</li>
        </Link>
        <Link to='/profile'>
        {currentUser ? (<img className='rounder-full h-7 w-7 object-cover' src={currentUser.avatar} alt='profile'/>) :( <li className=' sm:inline text-blue-900 hover:underline'>Sign In</li>)  }
        </Link>
